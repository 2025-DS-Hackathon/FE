...
단순 기술 구현을 넘어
세대 간 지식·경험의 간극을 기술로 해소하는 플랫폼 구축
---
...
| 🎨 이서진 | Frontend | UI 개발, 로그인/재능 등록/매칭 UI 구현 |
| 🎨 김정연 | Frontend | UI 개발, 마이페이지/메시지/알림 및 상태 관리 |
...
https://github.com/user-attachments/assets/cd9214b4-f453-4b32-8d32-51fd8568f9e6
